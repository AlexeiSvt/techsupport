...
func (c *FirstEmailCalculator) Calculate(ctx context.Context, claim models.UserClaim, support models.SupportContext, db models.DBRecord, weights models.Weights) models.CalcResult {
    ...
    // Access the flat structures directly.
    userEmail := claim.FirstEmail
    ...
    if logger != nil {
        // Log final results with the session identifier for tracing.
